...
const CardsData = [
  {
    ...
    bgColor: 'linear(to-tr, #5966c2, #9c50be, #b43d65)'
  },
  {
    ...
    bgColor: 'linear(to-tr, #ad4839, #943552, #692666)'
  },
  {
    ...
    bgColor: 'linear(to-tr, #85c891, #92c877)'
  },
  {
  ...
  {
    icon: 'https://uc6720c2731ea9135e4552c7825f.previews.dropboxusercontent.com/p/thumb/ABbK02CNe_sDsueiO-o-MqxrObWz3Z1p0yWbW5Ap2R48bYS6XHfUI9zBCZkeIpvU-2MniSFwaPFm3SpadyfLdLr5mKj_E5BSf6kokSHz2yZK67vfqKVACiKI1orFofsEGYeQDYFNsIw40pXDoNUBBdM5x5tM6whIRV5AyIWAC_ikC9Aws1uP6XKO6Yj5gOi2X5FlVx-gi8CVI_ziBVmsTiyaDlkXASDsZiXfslxoP8dT65mr_xaYaOLrD8CVeiEqUC2YPguaIjSmDjLiKR6wUIyQMtd7gZwlMH5T9oM9eXcfFBZchXD3TmppO35wMTNDdreij7MLkXVVTZ1E1wKtBkUH3BS0u8xl7SZc7plGoZqsHWf90VnkcQ_IPvoUMpmi_iA/p.png',
    title: 'Custom Domain',
    desc: 'Use xircus custom domain or your own domains for personalized branding',
    bgColor: 'linear(to-tr, #983750, #af463f, #b35c31)'
  },
]
